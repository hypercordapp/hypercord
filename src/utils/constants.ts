...
export const GUILD_IDS = [VENCORD_GUILD_ID];
...
/**
 * Original authors of plugins ported in from Equicord (https://github.com/Equicord/Equicord).
 * Kept separate from Devs so upstream attribution stays intact.
 */
