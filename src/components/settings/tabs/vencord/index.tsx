...
function VencordSettings() {
    const donateImage = HC_MASCOT_IMAGE;
        ...
        <SettingsTab>
            ...
            {isPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to HyperCord you now have a cool new badge!"
...
export default wrapTab(VencordSettings, "HyperCord Settings");
