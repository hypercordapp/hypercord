...
console.log("[HyperCord] Starting up...");
...
if (!IS_VANILLA) {
    ...
    console.log("[HyperCord] Running in vanilla mode. Not loading HyperCord");
}

console.log("[HyperCord] Loading original Discord app.asar");
