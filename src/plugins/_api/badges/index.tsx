...
const CATALOG_KEY_PRIORITY: Record<string, BadgePriority> = {
    ...
    account_age_seed: BadgePriority.AccountAge,
    account_age_sprout: BadgePriority.AccountAge,
    account_age_bud: BadgePriority.AccountAge,
    account_age_sapling: BadgePriority.AccountAge,
    account_age_blossom: BadgePriority.AccountAge,
    account_age_redwood: BadgePriority.AccountAge,
    account_age_sequoia: BadgePriority.AccountAge,
    account_age_bristlecone: BadgePriority.AccountAge,
    account_age_stromatolite: BadgePriority.AccountAge,
    account_age_primordial: BadgePriority.AccountAge,
    streaming_newcomer: BadgePriority.Streaming,
    streaming_fledgling: BadgePriority.Streaming,
    streaming_breakout: BadgePriority.Streaming,
    streaming_standout: BadgePriority.Streaming,
    streaming_trendsetter: BadgePriority.Streaming,
    streaming_headliner: BadgePriority.Streaming,
    streaming_star: BadgePriority.Streaming,
    streaming_sensation: BadgePriority.Streaming,
    streaming_visionary: BadgePriority.Streaming,
    streaming_phenomenon: BadgePriority.Streaming,
    game_time_casual: BadgePriority.GameTime,
    game_time_recreational: BadgePriority.GameTime,
    game_time_dedicated: BadgePriority.GameTime,
    game_time_committed: BadgePriority.GameTime,
    game_time_serious: BadgePriority.GameTime,
    game_time_devoted: BadgePriority.GameTime,
    game_time_seasoned: BadgePriority.GameTime,
    game_time_ironclad: BadgePriority.GameTime,
    game_time_unshakeable: BadgePriority.GameTime,
    game_time_eternal: BadgePriority.GameTime,
    game_variety_sampler: BadgePriority.GameVariety,
    game_variety_dabbler: BadgePriority.GameVariety,
    game_variety_enthusiast: BadgePriority.GameVariety,
    game_variety_ranger: BadgePriority.GameVariety,
    game_variety_explorer: BadgePriority.GameVariety,
    game_variety_adventurer: BadgePriority.GameVariety,
    game_variety_voyager: BadgePriority.GameVariety,
    game_variety_maverick: BadgePriority.GameVariety,
    game_variety_polymath: BadgePriority.GameVariety,
    game_variety_universalist: BadgePriority.GameVariety,
};
...
const REAL_BADGE_ID_PRIORITY: [RegExp, BadgePriority][] = [
    ...
    [/^account_age/i, BadgePriority.AccountAge],
    [/^streaming/i, BadgePriority.Streaming],
    [/^game_time/i, BadgePriority.GameTime],
    [/^game_variety/i, BadgePriority.GameVariety],
];
