...
const settings = definePluginSettings({
    ...
    showVencordDonor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show HyperCord donor badges in chat.",
        hidden: true,
        default: true
    },
    VencordDonorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the HyperCord Donor badges.",
        hidden: true,
        default: 4
    },
    showVencordContributor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show HyperCord contributor badges in chat.",
        hidden: true,
        default: true
    },
    VencordContributorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the HyperCord Contributor badge.",
        hidden: true,
        default: 5
    },
    showDiscordProfile: {
