...
import { Channel, MessageAttachment as MessageAttachment_ } from "@vencord/discord-types";

type MessageAttachment = MessageAttachment_ & { title?: string; description?: string; };
