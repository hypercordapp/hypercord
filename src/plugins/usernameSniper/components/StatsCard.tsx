    ...
    return (
        <div className="hypercord-sniper-stats-grid">
            ...
            <div className="hypercord-sniper-stat-card">
                ...
                <span className="hypercord-sniper-stat-value">
                    {stats.checksPerMinute}/dk
                </span>
            </div>

            <div className="hypercord-sniper-stat-card">
                <span className="hypercord-sniper-stat-label">Rate-Limit Yakalama</span>
                <span className="hypercord-sniper-stat-value" style={{ color: stats.rateLimitsHit > 0 ? "#FFAA00" : "#888" }}>
                    {stats.rateLimitsHit}
                </span>
            </div>
        </div>
