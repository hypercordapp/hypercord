...
import type { PaletteCommand, PaletteListItem } from "@plugins/commandPalette/api/types";
import { CompassIcon, GearIcon, HashIcon, HomeIcon, ServerIcon, UserIcon } from "@plugins/commandPalette/ui/icons";
